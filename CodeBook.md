...
The experiment data has been summarised in such a way that averages across volunteer and activity type are captured for a number of features.
...
Data transformations were applied to end up with the averages grouped by subject and activity. The R code to perform this is contained within the file 'run_analysis.R'. The broad steps that were performed includes:
